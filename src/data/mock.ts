...
export const INITIAL_CONTRIBUTIONS: ContributionItem[] = [
    ...
    },
    {
        id: '3',
        type: 'Song',
        title: 'Lullaby of the Lake',
        subtitle: 'Song • Swahili • Posted 3 days ago',
        status: 'Live',
        statusColor: 'text-success',
        dotColor: 'bg-success',
        icon: 'mic',
        ...
        language: 'Swahili',
        languageCode: 'sw',
        content: 'La la la mtoto wangu, usingizi ufike. Mama yuko karibu, usiogope giza.',
        translation: 'Sleep sleep my child, let sleep come. Mother is near, do not fear the darkness.',
        context: 'Traditional Swahili lullaby from the coastal region of Kenya.',
        tags: ['swahili', 'lullaby', 'song', 'coast'],
        moderationStatus: 'approved',
        reviewHistory: [
            {
                moderator: { id: 'm1', name: 'Sarah M.', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah' },
                action: 'approved',
    ...
    },
    {
        id: '4',
        type: 'Phrases',
        title: 'Common Greetings in Yoruba',
        subtitle: 'Phrases • Yoruba • Posted 5 days ago',
        ...
        language: 'Yoruba',
        languageCode: 'yo',
        content: 'E kaaro (Good morning)\nE kaasan (Good afternoon)\nE kaale (Good evening)\nO daaro (Good night)',
        context: 'Standard Yoruba greetings for different times of day. Collected from native speakers in Lagos.',
        tags: ['yoruba', 'greetings', 'phrases'],
        moderationStatus: 'needs_revision',
        reviewHistory: [
            {
                moderator: { id: 'm2', name: 'James K.', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=James' },
                action: 'critiqued',
                comment: 'The tonal marks are missing. Yoruba is a tonal language — please add proper diacritics.',
                timestamp: Date.now() - 1000 * 60 * 60 * 48,
            },
        ],
        moderatorNotes: 'Tonal marks required before approval.',
    },
    {
        id: '5',
        type: 'Story',
        title: 'The Weaver Bird',
        subtitle: 'Folklore • Kikuyu • Posted 1 week ago',
        status: 'Under Review',
        statusColor: 'text-warning',
        dotColor: 'bg-warning',
        icon: 'menu_book',
        ...
        language: 'Kikuyu',
        languageCode: 'ki',
        content: 'Nyoni ya nyumba ndĩagaga gĩthima. The weaver bird that builds many nests always finds water.',
        translation: 'The weaver bird that builds many nests never lacks a water source.',
        context: 'A Kikuyu animal fable teaching the value of hard work and preparation.',
        tags: ['kikuyu', 'folklore', 'fable', 'weaver bird'],
