            ...
            <div className="flex flex-col leading-none">
                <span
                    ...
                    style={{ 
                        color: colors.text, 
                        fontStyle: 'normal',
                        fontSize: typeof size === 'number' ? size * 0.384 : '0.384em',
                        lineHeight: 1.1
                    }}
                >
                    Samiati
                ...
                <span
                    ...
                    style={{ 
                        ...
                        fontStyle: 'normal', 
                        opacity: 0.8,
                        fontSize: typeof size === 'number' ? size * 0.112 : '0.112em'
                    }}
                >
