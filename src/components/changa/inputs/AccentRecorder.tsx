...
export const AccentRecorder = () => {
    ...
    return (
        <div className="bg-stone-50 dark:bg-black/20 rounded-2xl p-8 flex flex-col items-center justify-center border-2 border-dashed border-stone-300 dark:border-white/10">
            <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-6 transition-all duration-300 ${isRecording ? 'bg-red-500 animate-pulse shadow-[0_0_30px_rgba(239,68,68,0.5)]' : 'bg-[#cf6317] shadow-lg hover:scale-110 cursor-pointer'}`}
            ...
            {isRecording && (
                <div className="text-red-500 font-mono font-bold">00:12 / 02:00</div>
            )}
        </div>
    );
};
