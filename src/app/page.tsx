...
const testimonials = [
  ...
  {
    quote:
      "Finally, an app that treats African languages with the depth and respect they deserve.",
    name: "Fatima N.",
    role: "Educator",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We support a growing list of African languages including Swahili, Yoruba, Igbo, Amharic, Zulu, and many more. We're constantly adding new languages based on community demand.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Some features are available offline, including saved conversations and previously downloaded language packs. AI chat and real-time translation require an internet connection.",
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl font-display">
              ...
              <span className="block text-primary">African Languages.</span>
            </h1>
            <p className="mx-auto max-w-2xl text-lg text-stone-300 sm:text-xl">
              Explore, learn, and contribute to African language preservation with
              AI-powered chat, voice messages, and community challenges.
            </p>
            ...
            <div className="flex items-center justify-center gap-6 text-xs text-stone-400 sm:text-sm">
              <span className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-rasta-green" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              From AI-powered conversations to community-driven challenges,
              Samiati gives you the tools to learn, preserve, and share African
              languages.
            </p>
          </div>
      ...
      <section className="py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              Choose the plan that fits your language learning journey. Start free
              ...
              >
                ...
                <ul className="mt-6 flex-1 space-y-3">
                  {plan.features.map((feature) => (
                    ...
                    >
                      <svg
                        className="mt-0.5 h-4 w-4 shrink-0 text-rasta-green"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={2}
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-border bg-card p-8 text-center sm:p-12">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Join thousands of learners preserving African languages, one word at a
              time.
            </p>
            <div className="mt-8">
              <Button size="lg" asChild>
